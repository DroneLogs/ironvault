  ...
  const TERMS = {
    ...
    entropy: {
      ...
      body: [
        ...
        'Other password managers, Strongbox among them, estimate a passphrase from its characters and report a bigger number for the same phrase. Entropy belongs to how a password was made, not to how it looks afterwards: six words drawn from a list of 7,776 have 7,776 to the sixth possible outcomes and no more, whatever the letters suggest. The smaller number is the one an attacker faces.'
      ]
    },
    wordlist: {
